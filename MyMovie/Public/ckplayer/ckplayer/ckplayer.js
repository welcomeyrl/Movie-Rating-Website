...
function ckstyle() { //定义总的风格
	...
	*/
	...
	加载皮肤压缩包时提示文字的位置
		...
		7、文本框高度
	*/
	pm_advmarquee:'1,1,20,-200,50,18,0,0x000000,50,0,20,1,15,2000',
	/*
	...
	*/
	...
	advmarquee:escape('{a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12"}My Movie join us！{/font}{/a}'),
	/*
...
(function() {	
	var CKobject= {
		...
		embedSWF:function(C,D,N,W,H,V,P){
			...
			t='<a href="'+r+'" target="_blank">click to download plugin</a>',
			error={
				w:'can not play',
				f:'can not play'+t,
				v:'can not play'+t
