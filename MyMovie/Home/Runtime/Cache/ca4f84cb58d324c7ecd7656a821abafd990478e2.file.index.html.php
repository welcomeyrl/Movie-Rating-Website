<?php /* Smarty version Smarty-3.1.6, created on 2015-04-27 14:37:24
         compiled from "./Home/Tpl/Index/index.html" */ ?>
<?php /*%%SmartyHeaderCode:1899911081553d3deddcd670-69103434%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ca4f84cb58d324c7ecd7656a821abafd990478e2' => 
    array (
  ...
  'nocache_hash' => '1899911081553d3deddcd670-69103434',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_553d3dee18eb3',
  'variables' => 
  array (
    'ppt' => 0,
    'pv' => 0,
...
<?php if ($_valid && !is_callable('content_553d3dee18eb3')) {function content_553d3dee18eb3($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/MAMP/htdocs/MyMovie/ThinkPHP/Extend/Vendor/Smarty/plugins/modifier.date_format.php';
...
?>
					<li>
						<div class="desc">            
							...
							<p style="padding-top:10px;">Actor: <?php echo $_smarty_tpl->tpl_vars['pv']->value['cname'][0];?>
</p>
							<p style="text-indent:3em;"><?php echo $_smarty_tpl->tpl_vars['pv']->value['cname'][1];?>
</p>
							
							<p>Genre: <?php  $_smarty_tpl->tpl_vars['tv'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tv']->_loop = false;
...
&nbsp;
							<?php } ?></p>
							<p>Showtime:  <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['pv']->value['showtime'],'%Y-%m-%d');?>
</p>
							<p>Country: <?php echo $_smarty_tpl->tpl_vars['pv']->value['nation'];?>
</p>
							<!--
							<p style="padding-bottom:10px;">授权有效期： 2012年11月30日前均可看</p>
							<p>清晰度：<span class="def_ico"></span></p>
							-->
							<p>Review: <span class="stars"></span>（have <?php echo $_smarty_tpl->tpl_vars['pv']->value['replynum'];?>
 reviews）</p>         
			...
			<div id="main_left">
				...
				<div class="movie_hot">
					<div class="hot_head">
						...
						<span class="btn"><a>show more</a></span>
					</div>
					<div class="hot_list">
						<ul>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['filmname'];?>
				...
				<div class="movie_recent">
					<div class="recent_head">
						<span>Latest Popular Movies</span>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['filmname'];?>
				...
				<div class="movie_review">
					<div class="review_head">
						...
						<span   style="float:right;padding-top:8px;"><a href="__APP__/List/index">More hot comments>>></a></span>
					</div>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['filmname'];?>
								...
								<span style="display:inline-block; width:50px; color:#8CB5C3;">Reviews </span>
