...
class CommonAction extends Action {
	...
	public function insert(){
		...
		if ($result = $model->add()) { //保存成功
			...
			//失败提示
			$this->error(L('Add failed').$model->getLastSql());
		}
	...
	public function update() {
		...
		*/
		...
		if(false !== $model->save()) {
			...
			//成功提示
			$this->success(L('Update Successfully'));
		} else {
			//错误提示
			$this->error(L('Update Failed'));
		}
	}
	...
	protected function _list($model, $map = array(), $sortBy = '', $asc = false) {
		...
		//列表排序显示
		$sortImg = $sort;                                 //排序图标
		$sortAlt = $sort == 'desc' ? 'ascending sort' : 'inverted order';   //排序提示
