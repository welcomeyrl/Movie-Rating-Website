...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'records','prev'=>'last page','next'=>'next  page','first'=>'first','last'=>'last','theme'=>' %totalRow% %header% %nowPage%/%totalPage% page %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
    // 默认分页变量名
    protected $varPage;
